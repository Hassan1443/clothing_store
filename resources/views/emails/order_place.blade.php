...
<div class="container">
      ...
      <label style="float:right; ">Placed On: {{\Carbon\Carbon::parse( $order_details['order_date'])->format('d F, Y') }}</label>
      ...
      <tbody>
        ...
        <tr>
          ...
          <!-- <td>
            ...
            <img height="100" width="100" alt="Product Image" src="{{ public_path($product['image']) }}"  />
        </td> -->
